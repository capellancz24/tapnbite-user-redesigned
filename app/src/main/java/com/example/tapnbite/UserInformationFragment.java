...
public class UserInformationFragment extends Fragment {
     ...
     * @return A new instance of fragment FullscreenDialogUserFragment.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        close = view.findViewById(R.id.ibClose);
        textInputLayout = view.findViewById(R.id.menu);
        autoCompleteTextView = (AutoCompleteTextView) textInputLayout.getEditText();

        String[] items = {"Customer", "Seller", "Admin"};
        if (autoCompleteTextView != null) {
            ArrayAdapter<String> adapter = new ArrayAdapter<>(getContext(), R.layout.list_item_usertype, items);
